...
public class JadeSpiritTechnique extends GenericTechnique {

    public JadeSpiritTechnique(BasicStatChangeHandler statChangeHandler) {
        super(
                ModPaths.SOUL.getId(),
                Component.translatable("ascension.technique.jade_spirit_scripture"),
                1.0D,
                Set.of()
        );
    ...
    public Component getShortDescription() {
        return Component.translatable("ascension.technique.jade_spirit_scripture.description.short");
    }

    @Override
    public Component getDescription() {
        return Component.translatable("ascension.technique.jade_spirit_scripture.description");
    }
