...
public class SoulForgedWeaponTechnique extends GenericTechnique {
    ...
    public void onTechniqueRemoved(IEntityData heldEntity, ITechniqueData techniqueData) {
        ...
        heldEntity.removeSkill(ModSkills.SIMPLE_SOUL_CULTIVATION_SKILL.getId(), ModForms.SOUL_FORM.getId());
        heldEntity.removeSkill(ModSkills.SOUL_FORGE.getId(), ModForms.SOUL_FORM.getId());
